...
xst -ifn xst.scr
move image_core_pll_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\image_core_pll_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc image_core_pll_exdes.ucf image_core_pll_exdes

echo 'Running map'
map -timing -pr b image_core_pll_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm image_core_pll_exdes -w routed.ncd routed.v
cd ..
