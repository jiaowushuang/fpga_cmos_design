...
xst -ifn xst.scr
move DCM_CMOS_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\DCM_CMOS.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc DCM_CMOS.ucf DCM_CMOS_exdes

echo 'Running map'
map -timing -pr b DCM_CMOS_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm DCM_CMOS_exdes -w routed.ncd routed.v
cd ..
