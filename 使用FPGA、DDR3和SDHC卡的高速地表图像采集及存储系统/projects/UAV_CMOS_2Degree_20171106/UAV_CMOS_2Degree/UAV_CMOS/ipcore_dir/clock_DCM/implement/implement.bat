...
xst -ifn xst.scr
move clock_DCM_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\clock_DCM_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc clock_DCM_exdes.ucf clock_DCM_exdes

echo 'Running map'
map -timing -pr b clock_DCM_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm clock_DCM_exdes -w routed.ncd routed.v
cd ..
