...
xst -ifn xst.scr
move series10_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\series10_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc series10_exdes.ucf series10_exdes

echo 'Running map'
map -timing series10_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm series10_exdes -w routed.ncd routed.v
cd ..
