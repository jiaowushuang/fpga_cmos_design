...
vlog -work work series10_tb.v

REM run the simulation
vsim -c -t ps +transport_int_delays -voptargs="+acc" -L secureip -L simprims_ver -sdfmax series10_tb\dut=..\..\implement\results\routed.sdf +no_notifier work.series10_tb work.glbl
