...
xst -ifn xst.scr
move usb_dcm_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\usb_dcm_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc usb_dcm_exdes.ucf usb_dcm_exdes

echo 'Running map'
map -timing -pr b usb_dcm_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm usb_dcm_exdes -w routed.ncd routed.v
cd ..
