...
vlog -work work lvds_pll_tb.v

REM run the simulation
vsim -c -t ps +transport_int_delays -voptargs="+acc" -L secureip -L simprims_ver -sdfmax lvds_pll_tb\dut=..\..\implement\results\routed.sdf +no_notifier work.lvds_pll_tb work.glbl
