...
xst -ifn xst.scr
move lvds_pll_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\lvds_pll_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc lvds_pll_exdes.ucf lvds_pll_exdes

echo 'Running map'
map -timing -pr b lvds_pll_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm lvds_pll_exdes -w routed.ncd routed.v
cd ..
